...
# The neutral agreement logic moved to lib/execution_consistency (B2B) so
# entry and exit share ONE definition of "does this execution describe its
# plan?". Re-exported here because the B0 tests and callers import it from
# this module, and that import remains the compatibility contract.
from lib.execution_consistency import execution_disagreement  # noqa: E402,F401
